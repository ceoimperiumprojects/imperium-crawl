---
name: site-intel
description: "This skill should be used when the user asks to 'analyze this website', 'map this site', 'site audit', 'understand the structure of this website', 'website overview and analysis', 'crawl and analyze this site', or 'what is this website about'. Supports both MCP and CLI modes."
---
