---
name: research
description: "This skill should be used when the user asks to 'research a topic', 'find information about something', 'what is known about X', 'investigate Y', 'deep dive into Z', 'gather intel on a subject', or 'look into this topic'. Supports both MCP and CLI modes."
---
