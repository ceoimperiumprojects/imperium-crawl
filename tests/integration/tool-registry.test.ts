...
import { hasBraveApiKey, hasTwoCaptchaApiKey } from "../../src/core/config.js";
import { TwoCaptchaSolver } from "../../src/captcha/solver.js";

describe("Tool Registry", () => {
  it("has exactly 41 tools registered", () => {
  ...
  it("contains all expected tool names", () => {
    ...
    const expected = [
      ...
      "download", "rss",
      "pdf_extract", "watch", "monitor",
      "record_flow", "run_flow", "serve_flow",
      "list_flows", "inspect_flow", "validate_flow",
      "camofox_status", "camofox_update",
    ];
