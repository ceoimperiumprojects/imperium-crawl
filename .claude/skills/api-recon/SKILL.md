---
name: api-recon
description: "This skill should be used when the user asks to 'find APIs on a website', 'discover hidden endpoints', 'reverse engineer an API', 'what API calls does this site make', 'monitor WebSocket traffic', 'capture network requests', or 'API reconnaissance'. Supports both MCP and CLI modes."
---
...
> **Full tool reference:** See `../build-skill/tool-reference.md` for all parameters.
